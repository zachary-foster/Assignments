...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{coverage_hist}
  \captionof{figure}{Distribution of contig average coverage.}
  \label{fig:histogram}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{dotplot}
  \captionof{figure}{Dot plot of contigs vs. the refernece sequence they were derived from. }
  \label{fig:dotplot}
\end{minipage}
\end{figure}
